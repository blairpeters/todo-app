...
const Button = ({ label }) => {
  return (
    <button className="group relative flex h-14 w-56 cursor-pointer items-center justify-center overflow-hidden rounded-md border bg-sky-800 p-2 font-extrabold text-sky-50 duration-500 hover:border-sky-600">
